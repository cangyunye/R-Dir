...
export const ACTIONS: KeyAction[] = [
  ...
  A({ id: "focusAddress", label: "聚焦地址栏", group: "导航", win: "mod+l", mac: "mod+l" }),
  A({ id: "goHome", label: "前往主目录", group: "导航", win: "mod+shift+h", mac: "mod+shift+h" }),
  // 选择
  A({ id: "selectAll", label: "全选", group: "选择", win: "mod+a", mac: "mod+a" }),
  A({ id: "invertSelection", label: "反向选择", group: "选择", win: "mod+shift+a", mac: "mod+shift+a" }),
  A({ id: "clearSelection", label: "取消选择", group: "选择", win: "esc", mac: "esc" }),
  // 文件操作
  A({ id: "copy", label: "复制", group: "文件操作", win: "mod+c", mac: "mod+c" }),
  A({ id: "cut", label: "剪切", group: "文件操作", win: "mod+x", mac: "mod+x" }),
  A({ id: "paste", label: "粘贴", group: "文件操作", win: "mod+v", mac: "mod+v" }),
  ...
  A({ id: "undo", label: "撤销", group: "文件操作", win: "mod+z", mac: "mod+z" }),
  A({ id: "redo", label: "重做", group: "文件操作", win: "mod+y", mac: "mod+shift+z" }),
  A({ id: "properties", label: "属性栏", group: "文件操作", win: "alt+enter", mac: "mod+i" }),
  // 标签页
  A({ id: "newTab", label: "新标签页", group: "标签页", win: "mod+t", mac: "mod+t" }),
  A({ id: "closeTab", label: "关闭标签页", group: "标签页", win: "mod+w", mac: "mod+w" }),
  A({ id: "nextTab", label: "下一个标签页", group: "标签页", win: "mod+tab", mac: "ctrl+tab" }),
  A({ id: "prevTab", label: "上一个标签页", group: "标签页", win: "mod+shift+tab", mac: "ctrl+shift+tab" }),
  A({ id: "reopenTab", label: "恢复关闭的标签页", group: "标签页", win: "mod+shift+t", mac: "mod+shift+t" }),
  A({ id: "jumpTab1", label: "跳转到第 1 个标签页", group: "标签页", win: "mod+1", mac: "mod+1" }),
  A({ id: "jumpTab2", label: "跳转到第 2 个标签页", group: "标签页", win: "mod+2", mac: "mod+2" }),
  A({ id: "jumpTab3", label: "跳转到第 3 个标签页", group: "标签页", win: "mod+3", mac: "mod+3" }),
  A({ id: "jumpTab4", label: "跳转到第 4 个标签页", group: "标签页", win: "mod+4", mac: "mod+4" }),
  A({ id: "jumpTab5", label: "跳转到第 5 个标签页", group: "标签页", win: "mod+5", mac: "mod+5" }),
  A({ id: "jumpTab6", label: "跳转到第 6 个标签页", group: "标签页", win: "mod+6", mac: "mod+6" }),
  A({ id: "jumpTab7", label: "跳转到第 7 个标签页", group: "标签页", win: "mod+7", mac: "mod+7" }),
  A({ id: "jumpTab8", label: "跳转到第 8 个标签页", group: "标签页", win: "mod+8", mac: "mod+8" }),
  A({ id: "jumpTab9", label: "跳转到第 9 个标签页", group: "标签页", win: "mod+9", mac: "mod+9" }),
  // 分屏 / 窗格
  A({ id: "splitRow", label: "左右分屏", group: "分屏 / 窗格", win: "mod+\\", mac: "mod+\\" }),
  A({ id: "splitCol", label: "上下分屏", group: "分屏 / 窗格", win: "mod+j", mac: "mod+j" }),
  A({ id: "focusNextPane", label: "聚焦下一窗格", group: "分屏 / 窗格", win: "mod+shift+\\", mac: "mod+shift+\\" }),
  A({ id: "closePane", label: "关闭当前窗格", group: "分屏 / 窗格", win: "mod+shift+w", mac: "mod+shift+w" }),
  A({ id: "resetSplitRatio", label: "重置分屏比例", group: "分屏 / 窗格", win: "mod+0", mac: "mod+0" }),
  // 搜索
  A({ id: "focusSearch", label: "聚焦搜索（文件名）", group: "搜索", win: "mod+f", mac: "mod+f" }),
  A({ id: "focusSearchContent", label: "切换内容搜索", group: "搜索", win: "mod+shift+f", mac: "mod+shift+f" }),
  // 视图 / 全局
  A({ id: "toggleHidden", label: "显示/隐藏隐藏文件", group: "视图 / 全局", win: "mod+shift+.", mac: "mod+shift+." }),
